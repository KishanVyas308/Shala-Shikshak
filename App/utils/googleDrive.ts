/**
 * Utility functions for handling Google Drive URLs in React Native
 */
...
export function getGoogleDriveEmbedUrl(url: string): string {
  ...
  if (fileId) {
    // Return embedded viewer URL that works better with WebView
...
/**
 * Get Google Docs viewer URL for better compatibility
 * @param url - Google Drive URL
 * @returns Google Docs viewer URL
 */
